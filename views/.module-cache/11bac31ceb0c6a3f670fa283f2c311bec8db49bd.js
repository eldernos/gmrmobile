var DirectoryView = React.createClass({displayName: "DirectoryView",
    render: function() {
        return (
		   ...
		   React.createElement("span", null, "Hello beyotch."), 
           React.createElement("div", {id: "nav"}, 
        	React.createElement("div", {id: "navProfile"}, 
                React.createElement("div", {id: "profile"}, 
                    React.createElement("div", {id: "profileImage", style: "background:url(images/011924.jpg) no-repeat; background-size:cover; background-position:center;"})
                )
            ), 
