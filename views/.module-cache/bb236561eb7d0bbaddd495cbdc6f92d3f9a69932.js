			...
			React.createElement("div", {id: "directoryBox"}, 
		       React.createElement("div", {className: "leadCardContent"}, 
                ...
                React.createElement("div", {id: "directoryProfile"}, 
                    React.createElement("div", {id: "directoryProfileImage"}, React.createElement("img", {src: 'images/directory/' + this.props.item.DirectoryId + '.jpg', border: "0", width: "180", height: "180"}))
                ), 
