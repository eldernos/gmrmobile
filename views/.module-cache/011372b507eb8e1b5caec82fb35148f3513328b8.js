						...
						React.createElement("div", {className: "card"}, 
            				React.createElement("div", {className: "cardContent"}, 
								React.createElement("div", {className: "thumbnail"}, 
									React.createElement("div", {className: "thumbnailImage"}, React.createElement("img", {src: 'https://fbservices.gmrmarketing.com/GetDirectoryPhoto/' + item.DirectoryId, border: "0"}))
								), 
