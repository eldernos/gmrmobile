        	...
        	React.createElement("div", {className: "leadCardContent"}, 
                ...
                React.createElement("div", {className: "formFields"}, 
                    ...
                    React.createElement("br", null), 
                        React.createElement("input", {type: "text", id: "txtFirstName", placeholder: "first name", onChange: this.handleFirstNameChange}), 
                        React.createElement("img", {src: "images/icon-profile.png", id: "input_img"})
                    ), 
                    
                    React.createElement("div", {className: "input_container"}, 
                    React.createElement("br", null), 
                        React.createElement("input", {type: "text", id: "txtLastName", placeholder: "last name", onChange: this.handleLastNameChange}), 
                        React.createElement("img", {src: "images/icon-profile.png", id: "input_img"})
                    ), 
                    
                    React.createElement("div", {className: "input_container"}, 
                    React.createElement("br", null), 
                        React.createElement("input", {type: "text", id: "txtPosition", placeholder: "position", onChange: this.handlePositionChange}), 
                        React.createElement("img", {src: "images/icon-profile.png", id: "input_img"})
                    ), 
                   
                    React.createElement("div", {className: "input_container"}, 
                    React.createElement("br", null), 
                        React.createElement("input", {type: "text", id: "txtSupervisor", placeholder: "supervisor", onChange: this.handleSupervisorChange}), 
                        React.createElement("img", {src: "images/icon-profile.png", id: "input_img"})
                    ), 
                    
                    React.createElement("div", {className: "input_container"}, 
                    React.createElement("br", null), 
                        React.createElement("input", {type: "text", id: "txtLocation", placeholder: "office location", onChange: this.handleLocationChange}), 
